...
__thread char alloc_errno_location[MAX_ERR_LINE_LENGTH];
__thread char alloc_errno_msg[MAX_ERR_STRING_LENGTH];
__thread char alloc_errno_strerr[MAX_ERR_LINE_LENGTH];
