...
#ifndef C_HYBRID_TLSF_FIXED_HEAP_ALLOCATOR_CONTROLLER
#define C_HYBRID_TLSF_FIXED_HEAP_ALLOCATOR_CONTROLLER
...
#endif // C_HYBRID_TLSF_FIXED_HEAP_ALLOCATOR_CONTROLLER